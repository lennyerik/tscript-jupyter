define(function() {
    return { onload: function() {
        console.log("Loading TScript syntax");

        // This is an adapted version of tscript/src/ide/codemirror-tscriptmode.ts
                ...
                return {
                    ...
                    indent: function (state, textAfter) {
                        if (textAfter && textAfter[0] == "}")
                            return state.prev == "{" ? state.indent : state.indent - 4;
